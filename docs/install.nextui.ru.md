# Установка BRKCHRD 0.5.2 в NextUI
...
Распакуйте архив 0.5.2 поверх существующего дерева `Tools/tg5040/`. Не удаляйте `.userdata`, если не нужен сброс к заводским значениям.
