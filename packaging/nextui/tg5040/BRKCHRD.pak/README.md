# BRKCHRD 0.5.2 — NextUI Pak

Native `tg5040` package for TrimUI Brick and compatible NextUI devices.

## Install

Copy the two paths from the release archive to the root of the SD card:
...
The launcher stores user configuration in:
...
Full English and Russian documentation is included in `docs/`.
